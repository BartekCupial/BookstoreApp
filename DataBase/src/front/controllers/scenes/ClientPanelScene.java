...
public class ClientPanelScene extends Controller {
    ...
    public void OrdersHandler(Event e) {
        ...
        BuildTableSQL(ordersTable, SQLQuery);
    }
    ...
    public void BooksHandler(Event e) {
        ...
        BuildTableSQL(booksTable, SQLQuery);
    }
    ...
    public void SectionsHandler(Event e) {
        ...
        BuildTableSQL(sectionsTable, SQLQuery);
    }
    ...
    public void AuthorsHandler(Event e) {
        ...
        BuildTableSQL(authorsTable, SQLQuery);
    }
    ...
    public void BasketHandler(Event e) {
        ...
        BuildTableSQL(basketTable, SQLQuery);
    }
}
